...
{                console.log(eachRecipe)
                            ...
                            <img src={eachRecipe.image} alt="" height={100} width={100}/>
                            <CustomHeading heading={`Ingredients for ${eachRecipe.name}`}/>
                            <CustomOrderList list={eachRecipe.ingredients}/>
                            <CustomHeading heading={`Instructions for ${eachRecipe.name}`}/>
